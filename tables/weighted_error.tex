...
\hspace{7pt}3rd Quartile & 1.0 & 1.01 & 1.01 & \cellcolor{bronze!60}1.01 \\ 
\addlinespace[1ex] 
\textbf{KernelSHAP Paired} &  &  &  &  \\ 
\hspace{7pt}Mean & 1.0 & 1.0 & 1.0 & 1.01 \\ 
\hspace{7pt}1st Quartile & \cellcolor{bronze!60}1.0 & 1.0 & \cellcolor{silver!60}1.0 & 1.01 \\ 
\hspace{7pt}2nd Quartile & \cellcolor{bronze!60}1.0 & 1.0 & \cellcolor{bronze!60}1.0 & 1.01 \\ 
\hspace{7pt}3rd Quartile & 1.0 & 1.0 & 1.0 & 1.01 \\ 
\addlinespace[1ex] 
\textbf{Official KernelSHAP} &  &  &  &  \\ 
\hspace{7pt}Mean & \cellcolor{silver!60}1.0 & \cellcolor{gold!60}1.0 & \cellcolor{silver!60}1.0 & \cellcolor{gold!60}1.0 \\ 
\hspace{7pt}1st Quartile & \cellcolor{gold!60}1.0 & \cellcolor{gold!60}1.0 & 1.0 & \cellcolor{silver!60}1.0 \\ 
\hspace{7pt}2nd Quartile & \cellcolor{gold!60}1.0 & \cellcolor{gold!60}1.0 & 1.0 & \cellcolor{silver!60}1.0 \\ 
\hspace{7pt}3rd Quartile & \cellcolor{silver!60}1.0 & \cellcolor{silver!60}1.0 & \cellcolor{silver!60}1.0 & \cellcolor{gold!60}1.0 \\ 
\addlinespace[1ex] 
\textbf{LeverageSHAP} &  &  &  &  \\ 
