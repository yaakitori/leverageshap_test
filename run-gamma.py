...
for y_name in ['shap_error', 'weighted_error']:
    ...
    ls.plot_with_subplots(results, x_name, y_name, filename=f'images/main_gamma_{y_name}.pdf', log_x=True, log_y=False, include_estimators=main_estimators, plot_mean=False)
